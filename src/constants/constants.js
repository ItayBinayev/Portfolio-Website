export const projects = [
  {
    ...
    description: "The project is developed using a combination of JavaScript, ASP.NET, Bootstrap, and MSSQL. It aims to provide a URL shortening service, allowing users to input a long URL and obtain a shorter, more manageable URL that redirects to the original destination.",
...
export const TimeLineData = [
  { year: 2022, text: 'Started Full-Stack and Software Development Course at Sela', },

  { year: 2023, text: 'Finished Full-Stack and Software Development Course at Sela', }
